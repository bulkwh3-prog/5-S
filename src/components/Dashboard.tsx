...
import { Download, Trash2, Calendar, MapPin, User, Trophy, ChevronRight, RefreshCw, Layers } from "lucide-react";
...
export function Dashboard({ dbState, onDeleteReport }: DashboardProps) {
