              ...
              <div className="flex flex-wrap items-center gap-3 justify-center md:justify-end shrink-0 w-full md:w-auto">
                {googleUser ? (
                  ...
                  <button
                    ...
                    className="gsi-material-button inline-flex items-center justify-center gap-2 px-5 py-3 border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 text-slate-700 font-black rounded-2xl text-xs transition shadow-xs cursor-pointer active:scale-95 animate-pulse"
                  >
